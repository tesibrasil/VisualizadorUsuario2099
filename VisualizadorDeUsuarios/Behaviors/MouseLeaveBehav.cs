...
namespace TesiNexus.Behaviors
{
    public class MouseLeaveBehav : AvaloniaObject
    {
        ...
        public static readonly AttachedProperty<ICommand> CommandProperty = AvaloniaProperty.RegisterAttached<MouseLeaveBehav, Interactive, ICommand>(
        ...
        public static readonly AttachedProperty<object> CommandParameterProperty = AvaloniaProperty.RegisterAttached<MouseLeaveBehav, Interactive, object>(
